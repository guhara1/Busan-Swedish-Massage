#!/usr/bin/env python3
"""간다 GO — 부산 출장마사지·홈타이 정적 사이트 빌드 스크립트.
...
<header class="site-header">
  ...
  <div class="header-top">
    <div class="header-inner">
      ...
      <p class="header-tagline"><span class="tag-gem">◆</span> 부산 전지역 방문 관리 <span class="tag-gem">◆</span> 24시간 상담</p>
...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <p class="footer-desc">부산 전지역 방문 출장마사지·홈타이 안내 사이트입니다. 모든 서비스는 안내된 관리 범위와 위생·안전 기준 안에서만 제공됩니다.</p>
      <address class="footer-contact">
        ...
        <span class="footer-contact-row"><span class="footer-label">서비스 지역</span> 부산광역시 전지역</span>
      </address>
    </div>
    <nav class="footer-col" aria-label="서비스 안내">
      <p class="footer-title">서비스</p>
      <ul>
        <li><a href="/busan/">부산 출장마사지</a></li>
        <li><a href="/regions/">지역별 안내</a></li>
        <li><a href="/stations/">지하철역별 안내</a></li>
...
def build() -> None:
    ...
    for page in PAGES:
        path = page["path"]  # "" 또는 "regions/jung/" 형태
